...
const programs = [
  {
    ...
    slug: '01',
    description: 'A volunteer sits with a few children, opens the notebook, and notices where the confusion begins.',
    image: 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=1200&q=80',
  },
  {
    title: 'Voice Rooms',
    slug: '02',
    description: 'Practice spaces where confidence is rehearsed: one sentence today, a debate next week.',
...
export default function Home() {
  return (
    <>
        ...
        <Container>
          <div className="max-w-5xl">
            ...
            <h1 className="font-heading text-6xl sm:text-8xl font-bold text-espresso mb-12 leading-[0.9] tracking-tighter">
              Not charity.<br />
              <span className="text-cinnamon italic font-accent font-normal underline decoration-ice-cube/50 underline-offset-8">A weekly promise.</span>
            </h1>
            
            <div className="editorial-grid">
              <div className="lg:col-span-7">
                <p className="story-copy text-2xl sm:text-3xl mb-10 text-espresso">
                  Bloom is a student-run initiative that shows up for children through study circles, confidence rooms, and creative labs. We do the small work repeatedly until it becomes trust.
                </p>
              ...
              <div className="lg:col-span-5 relative">
                <div className="field-note transform lg:rotate-2">
                  <p className="text-sm font-semibold mb-2 uppercase tracking-widest text-cinnamon">Field note #24</p>
              ...
              <div key={idx} className="ledger-row group">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-espresso/60 mt-1 max-w-lg">
                    Every session is recorded in our distribution logs and attendance sheets to ensure continuity of care.
                  </p>
                </div>
              </div>
            ))}
      ...
      {/* Programs: Asymmetrical Editorial Grid with Smooth Images */}
        ...
        <Container>
          <div className="mb-20 lg:flex items-end justify-between gap-10">
            <div className="max-w-2xl">
              ...
              <p className="story-copy">
                Each format is built for rooms full of real children, limited time, and volunteers who are learning to lead while serving.
              </p>
            </div>
            <div className="mt-8 lg:mt-0">
              <Link href="/programs" className="text-cinnamon font-bold hover:underline underline-offset-8 decoration-2">
          ...
          <div className="space-y-32">
            {programs.map((program, idx) => (
              <div key={idx} className={`editorial-grid ${idx % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                <div className="lg:col-span-6">
                  <div className="relative aspect-[4/3] overflow-hidden group rounded-3xl">
                    ...
                    />
                    <div className="absolute top-6 left-6 bg-espresso/90 backdrop-blur-sm text-white px-5 py-3 rounded-2xl font-heading font-bold text-xl">
                      {program.slug}
                    </div>
                  </div>
                </div>
                <div className="lg:col-span-5 lg:col-start-8">
                  ...
                  <Button variant="outline" className="border-espresso text-espresso hover:bg-espresso hover:text-white transition-all">
      ...
      {/* Quote: The Voice with Soft Backdrop */}
      <section className="section-padding px-4 sm:px-6">
        <Container className="bg-espresso text-horchata p-12 sm:p-24 rounded-block text-center relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-cinnamon/20 rounded-full blur-3xl -mr-32 -mt-32" />
      ...
      {/* CTA: Handcrafted Feel with Smooth Corners */}
      <section className="section-padding bg-white">
        <Container>
          <div className="bg-horchata/30 p-10 sm:p-24 text-center relative overflow-hidden rounded-block">
            <div className="absolute -bottom-24 -left-24 w-64 h-64 bg-ice-cube/40 rounded-full blur-3xl" />
            <div className="relative z-10">
              <h2 className="accent-statement mb-8">Come with prepared hands.</h2>
              <p className="story-copy mx-auto mb-12 text-espresso/80">
