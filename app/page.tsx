        ...
        <Container>
          <div className="max-w-5xl">
            ...
            <h1 className="font-heading text-6xl sm:text-8xl font-bold text-espresso mb-12 leading-[0.9] tracking-tighter">
              Not charity.<br />
              <span className="text-cinnamon italic font-accent font-normal">A weekly promise.</span>
            </h1>
            ...
            {programs.map((program, idx) => (
              <div key={idx} className={`editorial-grid ${idx % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                ...
                <div className="lg:col-span-5 lg:col-start-8">
                  ...
                  <Button variant="outline" className="rounded-none border-espresso text-espresso hover:bg-espresso hover:text-white transition-all">
