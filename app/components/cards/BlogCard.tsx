...
export function BlogCard({
  ...
  return (
    <Link
      href={`/blog/${slug}`}
      className={clsx(
        'group block border-t border-espresso/10 pt-12 transition-all hover:bg-horchata/5 px-6 -mx-6 rounded-3xl',
        className
      )}
    >
      <article className="flex flex-col gap-8">
        <div className="flex items-center justify-between gap-4">
          ...
          {readingTime && (
            <span className="text-[10px] font-bold text-espresso/30 uppercase tracking-widest">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          <div className={clsx('lg:col-span-7', !coverImage && 'lg:col-span-12')}>
            ...
            <p className="story-copy text-lg line-clamp-3 mb-8 text-espresso/70">{excerpt}</p>
