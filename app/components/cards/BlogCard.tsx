...
export function BlogCard({
  ...
  return (
    <Link
      href={`/blog/${slug}`}
      className={clsx(
        'group block border-t border-espresso/10 pt-8 transition-colors hover:bg-horchata/5',
        className
      )}
    >
      <article className="flex flex-col gap-6">
        <div className="flex items-center justify-between gap-4">
          ...
          {readingTime && (
            <span className="text-[10px] font-bold text-espresso/40 uppercase tracking-widest">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className={clsx('lg:col-span-8', !coverImage && 'lg:col-span-12')}>
            ...
            <p className="story-copy text-base line-clamp-3 mb-6">{excerpt}</p>
