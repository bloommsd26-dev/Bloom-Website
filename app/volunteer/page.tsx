          ...
          <div className="editorial-grid">
            <div className="lg:col-span-7">
              ...
              <h1 className="accent-statement mb-8">
                We show up, <br />
                <span className="italic font-accent font-normal text-cinnamon text-5xl sm:text-7xl underline decoration-ice-cube decoration-4 underline-offset-8">week after week.</span>
              </h1>
            ...
            <div className="lg:col-span-5 relative hidden lg:block">
              <div className="field-note transform lg:-rotate-2 shadow-xl">
                <p className="text-xs font-bold mb-4 uppercase tracking-[0.2em] text-cinnamon">Our Requirement</p>
          ...
          <div className="editorial-grid items-start">
            <div className="lg:col-span-4">
              <div className="sticky top-32 space-y-16">
                <div>
                  <h3 className="font-heading text-2xl font-bold mb-6 text-espresso">The Commitment</h3>
                ...
                <div className="p-8 bg-ice-cube/20 rounded-3xl border border-ice-cube/50">
                  <h3 className="font-heading text-2xl font-bold mb-6 text-espresso">The Training</h3>
                  <p className="text-espresso/60 text-lg leading-relaxed">
              ...
              <div className="space-y-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-10">
                  ...
                  <div className="space-y-6">
                    <p className="text-xs font-bold uppercase tracking-widest text-espresso/40">Areas of Interest</p>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {['Education', 'Personality', 'Creative', 'Women Empowerment', 'Community'].map((area) => (
                        <label key={area} className="flex items-center gap-4 cursor-pointer group bg-horchata/5 p-4 rounded-2xl border border-transparent hover:border-cinnamon/20 transition-all">
                          <input type="checkbox" name="interests" value={area.toLowerCase()} className="w-5 h-5 accent-cinnamon rounded-full" />
                          <span className="text-espresso/70 font-bold group-hover:text-espresso transition-colors">{area}</span>
                        </label>
                      ))}
                    </div>
                  </div>
