        ...
        <Container>
          <div className="max-w-4xl">
            ...
            <p className="story-copy">
              Your contributions directly support the preparation and execution of our sessions. We
              prioritize practical resources that children can use immediately.
            </p>
          </div>
        </Container>
      </section>
            ...
            <div className="lg:col-span-6">
              ...
              <div className="space-y-6">
                {needs.map((need, idx) => (
                  <div
                    key={idx}
                    className="flex gap-6 items-start p-6 bg-white border border-espresso/5"
                  >
            ...
            <div className="lg:col-span-5 lg:col-start-8 relative">
              ...
              <div className="field-note mt-10">
                <p className="text-sm italic">
                  "We collect what can actually be used, sort it carefully, and record it in our
                  distribution logs."
                </p>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              {[
                ...
                <div
                  key={idx}
                  className="p-10 border border-espresso/10 hover:border-cinnamon transition-colors group"
                >
                  <p className="text-4xl font-black text-espresso mb-4 tabular-nums group-hover:text-cinnamon">
                    {tier.amount}
                  </p>
            ...
            <div className="bg-espresso text-horchata p-10 sm:p-16">
              ...
              <Button
                size="lg"
                className="rounded-none bg-cinnamon text-white hover:bg-cinnamon/90 border-none"
              >
      ...
      <section className="section-padding bg-horchata border-t border-espresso/5">
        <Container>
          <div className="max-w-2xl mx-auto text-center">
            <p className="font-heading text-xs font-bold uppercase tracking-widest text-espresso/40 mb-6">
              Transparency
            </p>
            <p className="story-copy text-espresso/80 italic">
              "Bloom is a student-led organization. Every rupee received is logged and accounted for
              in our monthly ledger. Donors receive a summary of how their contribution was
              utilized."
            </p>
          </div>
        </Container>
